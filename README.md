...
This repository contains my course capstone project, where I apply programming and data analysis skills to explore, clean, analyze, and present insights from real-world datasets. The goal is to demonstrate my ability to think analytically, write clean code, and follow a complete data or bioinformatics workflow from raw data to results.
